...
public class Projeto {
    ...
    // para recriar um Projeto que já existe no banco, com todos os seus dados.
    public Projeto(int id, String nome, String descricao,
            LocalDate dataInicioPrevista, LocalDate dataInicioReal,
            LocalDate dataTerminoPrevista, LocalDate dataTerminoReal,
            StatusProjeto status, Gerente gerente) {
        this.id = id;
        this.nome = nome;
    ...
    // Métodos de domínio: ações que o projeto pode realizar, como adicionar tarefas
    // ou equipes
    public void iniciar() {
